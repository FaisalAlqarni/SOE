...
description: The Chief Security Officer (CSO) board lens — evaluates authentication, data protection, input validation, API security, and compliance/risk. Used as one of the 5 personas in a full board meeting.
---
