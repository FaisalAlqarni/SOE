...
```
/soe:instinct-import team-instincts.yaml
/soe:instinct-import https://github.com/org/repo/instincts.yaml
/soe:instinct-import --from-skill-creator acme/webapp
```
...
Run /soe:instinct-status to see all instincts.
```
