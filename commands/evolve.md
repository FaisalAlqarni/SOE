...
```
/soe:evolve                    # Analyze all instincts and suggest evolutions
/soe:evolve --domain testing   # Only evolve instincts in testing domain
/soe:evolve --dry-run          # Show what would be created without creating
/soe:evolve --threshold 5      # Require 5+ related instincts to cluster
```
...
---
Run `/soe:evolve --execute` to create these files.
```
