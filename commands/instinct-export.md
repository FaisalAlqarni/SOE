...
```
/soe:instinct-export                           # Export all personal instincts
/soe:instinct-export --domain testing          # Export only testing instincts
/soe:instinct-export --min-confidence 0.7      # Only export high-confidence instincts
/soe:instinct-export --output team-instincts.yaml
```
